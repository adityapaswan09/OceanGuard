...
export function MapSurface({ activeLayer, onLayerChange, investigationTab, aisTracks, highlightedVesselId, analysis }: MapSurfaceProps) {
    return (
        <section className="relative min-h-[430px] flex-1 overflow-hidden border-b border-line bg-[#dfe9dd] lg:min-h-0">
            <MapView activeLayer={activeLayer} investigationTab={investigationTab} aisTracks={aisTracks} highlightedVesselId={highlightedVesselId} analysis={analysis} />
